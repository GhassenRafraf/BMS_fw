...
osStaticThreadDef_t Task_BMS_MainControlBlock;
const osThreadAttr_t Task_BMS_Main_attributes = {
  .name = "Task_BMS_Main",
  .cb_mem = &Task_BMS_MainControlBlock,
  .cb_size = sizeof(Task_BMS_MainControlBlock),
  .stack_mem = &Task_BMS_MainBuffer[0],
...
osStaticThreadDef_t Task_CAN_TxControlBlock;
const osThreadAttr_t Task_CAN_Tx_attributes = {
  .name = "Task_CAN_Tx",
  .cb_mem = &Task_CAN_TxControlBlock,
  .cb_size = sizeof(Task_CAN_TxControlBlock),
  .stack_mem = &Task_CAN_TxBuffer[0],
...
osStaticThreadDef_t Task_CAN_RxControlBlock;
const osThreadAttr_t Task_CAN_Rx_attributes = {
  .name = "Task_CAN_Rx",
  .cb_mem = &Task_CAN_RxControlBlock,
  .cb_size = sizeof(Task_CAN_RxControlBlock),
  .stack_mem = &Task_CAN_RxBuffer[0],
